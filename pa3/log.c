...
void printReceiveAllStarted(timestamp_t timestamp, local_id id) {
...
void logTransferOut(timestamp_t timestamp, local_id src, local_id dst, balance_t amount){
    fprintf(eventsLog, log_transfer_out_fmt, timestamp, src, amount, dst);
...
void logTransferIn(timestamp_t timestamp, local_id src, local_id dst, balance_t amount){
    fprintf(eventsLog, log_transfer_in_fmt, timestamp, dst, amount, src);
